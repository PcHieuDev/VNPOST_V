...
<body x-data="reportPage()">
    ...
    <div class="report-alert-container" x-show="message || error" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100"
        x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 transform scale-100"
        x-transition:leave-end="opacity-0 transform scale-90" style="pointer-events: none;">
        ...
        <div class="report-grid">
            ...
            <div class="report-card">
                    ...
                    <div class="dynamic-fields-grid">
                        <template x-for="field in selectedServiceConfig" :key="field.key">
                            <div>
                                ...
                                <input :type="field.type" :step="field.type === 'number' ? 'any' : ''"
                                    :placeholder="field.label" x-model.number="form.DuLieuChiTiet[field.key]">
                            </div>
                        </template>
                    </div>
                </div>
                ...
                <div x-show="!form.service_id"
                    style="min-height: 150px; display: flex; align-items: center; justify-content: center; color: #888;">
                ...
                <div class="report-actions">
                    ...
                    <input type="file" accept=".xlsx, .xls" x-ref="fileInput" @change="handleFileChange($event)"
